  ...
  <div class="main-layout">
    ...
    <div class="mt24 layout-main">
      <div class="add-left">
        ...
        <div class="mt20">
          <span>投放页面：</span>
          <el-select v-model="info.onThePage" placeholder="请选择" @change="changePage()">
            <el-option
        ...
        <div class="mt20">
          <span>广告位：</span>
          <el-select v-model="info.adSpaceName" placeholder="请选择" @change="getdata">
            <el-option
